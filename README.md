...
- **Κασσετίνα — δώρο (B2B εξαίρεση):**
  - Toggle **«Εξαίρεση κασσετίνας δώρου για B2B ομάδες»**: όταν είναι **ON**, οι χρήστες των ομάδων στη λίστα **δεν** βλέπουν metabox/προφίλ/email κασσετίνας. Όταν είναι **OFF**, η λίστα **αγνοείται** (κανείς δεν κρύβεται λόγω B2B).
  - **Λίστα B2B King group IDs** (π.χ. `34`).
  - **Κείμενο email** για το κουμπί «Ενημέρωση πελάτη για κασσετίνα» (ή προεπιλογή αν είναι κενό).
...
- **B2B King — Group ID** του Pappou Club.

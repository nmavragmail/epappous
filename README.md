...
- **Κασσετίνα — δώρο:** **κείμενο email** για το κουμπί «Ενημέρωση πελάτη για κασσετίνα» (οι διακόπτες/λίστα B2B για απόκρυψη κασσετίνας βρίσκονται στην καρτέλα **WooCommerce**).
...
- **B2B King — Group ID** του Pappou Club, **toggle εξαίρεσης κασσετίνας για B2B ομάδες** και **λίστα B2B King group IDs χωρίς κασσετίνα** (π.χ. `34`).
...
Προσοχή: το script αντικαθιστά ολόκληρο το `.docx` — αν έχετε επικολλήσει δικά σας screenshots, κρατήστε αντίγραφο πριν την αναδημιουργία.
